...
ActiveRecord::Schema[8.0].define(version: 2025_12_21_190000) do
  ...
  create_table "game_teams", force: :cascade do |t|
    ...
    t.string "ip_address"
    t.string "ctf01d_id"
    t.jsonb "ctf01d_overrides", default: {}, null: false
    t.string "team_type"
    t.integer "order", default: 0, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["game_id", "order", "id"], name: "index_game_teams_on_game_id_and_order_and_id"
    t.index ["game_id", "team_id"], name: "index_game_teams_on_game_id_and_team_id", unique: true
  ...
  create_table "services", force: :cascade do |t|
    ...
    t.jsonb "ctf01d_training", default: {}, null: false
