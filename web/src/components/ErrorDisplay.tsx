...
export function ForbiddenDisplay() {
  return <div className="error-display">You do not have permission to access this resource.</div>
}
...
export function ActionButton({ onClick, children, variant = 'default', disabled, confirm }: {
  onClick: () => void
  children: ReactNode
