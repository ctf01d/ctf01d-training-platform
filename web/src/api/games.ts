...
export async function getCtf01dExportOptions(id: number) {
  return client.GET('/games/{id}/export/ctf01d/options', { params: { path: { id } } })
}

export async function exportCtf01d(id: number, body?: components['schemas']['Ctf01dExportRequest']) {
